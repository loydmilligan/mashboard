...
export function SessionManager({ className }: SessionManagerProps): JSX.Element {
  const {
    activeThemeId,
    activeSessionId,
    getThemeSessions,
...
export function SessionSelectorCompact({ className }: { className?: string }): JSX.Element {
  const {
    activeThemeId,
    activeSessionId,
    activeSession,
...
export function SessionBadge(): JSX.Element | null {
