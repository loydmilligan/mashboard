...
function StarRating({ value, onChange, label }: StarRatingProps): JSX.Element {
...
function YouTubeEmbed({ videoId, searchQuery }: { videoId?: string; searchQuery: string }): JSX.Element {
...
function SpotifyEmbed({ trackId, searchQuery }: { trackId?: string; searchQuery: string }): JSX.Element {
...
export function SongDetailSlideout({
  ...
  open,
  onOpenChange,
}: SongDetailSlideoutProps): JSX.Element {
